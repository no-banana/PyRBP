...
def cife(features, labels, num_features):
    print(type(labels))
...
def icap(features, labels, num_features):
...
def jmi(features, labels, num_features):
...
def mifs(features, labels, num_features):
...
def mim(features, labels, num_features):
...
def mrmr(features, labels, num_features):
...
def fisherScore(features, labels, num_features):
...
def relief_f(features, labels, num_features):
...
def traceRatio(features, labels, num_features):
...
def llL21(features, labels, num_features):
...
def lsL21(features, labels, num_features):
    labels = to_categorical(labels)
...
def cfs(features, labels, num_features): # time-consuming
...
def chiSquare(features, labels, num_features):
...
def fScore(features, labels, num_features):
...
def giniIndex(features, labels, num_features):
    label = []
    for item in labels:
        if item == '1':
            label.append(1)
...
def tScore(features, labels, num_features):
